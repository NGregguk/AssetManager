...
namespace asset_manager.Migrations
{
    ...
    [Migration("20260204130933_AddGuides")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("asset_manager.Models.FloorPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("asset_manager.Models.Guide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("asset_manager.Models.GuideCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("asset_manager.Models.AssetPin", b =>
                {
                    ...
                    b.HasOne("asset_manager.Models.FloorPlan", "FloorPlan")
                        .WithMany("Pins")
            ...
            modelBuilder.Entity("asset_manager.Models.Guide", b =>
                {
                    b.HasOne("asset_manager.Models.GuideCategory", "GuideCategory")
                        .WithMany("Guides")
